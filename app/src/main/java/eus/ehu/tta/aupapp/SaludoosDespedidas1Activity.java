...
public class SaludoosDespedidas1Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        enunciado.setText(tests.get(1).getEnunciado());

        respuestasCorrecta = tests.get(1).getRespuestCorrecta();

        RadioGroup group = (RadioGroup) findViewById(R.id.elecciones_test);
        int i=0;

        for( String resp : tests.get(1).getRespuestas()) {
    ...
    public void siguiente(View view){
        Intent intent = new Intent(this, SaludosDespedidas2Activity.class);
